	...
	return (
		<div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-6">
			<div className="bg-white rounded-2xl shadow-lg p-8 w-[350px] max-w-[1290px] text-center">
				...
				<h1 className="text-2xl font-bold text-gray-800 mb-3">¡Pedido confirmado!</h1>
				...
				<Link
					to="/products"
					className="px-6 py-3 rounded-lg bg-primary-pressed text-white font-medium hover:bg-primary-hover transition"
				>
					Seguir comprando
				</Link>
			</div>
